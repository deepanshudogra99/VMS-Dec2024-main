<div>
  <div>
    <!-- Add VC Modal -->
    @if ($addmodal)
    <div class="modal-overlay" wire:model="showmodal"
  ...
  @endif
    <!-- Edit VC Modal -->
    @if ($editModal)
    <div class="modal-overlay" wire:model="editModal"
      style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5); z-index: 1040;">
    </div>
    <div class="modal fade show" tabindex="-1" style="display: block;" aria-hidden="false">
      <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <h5 class="modal-title mx-auto" id="addVCModalLabel">Edit/Update VC</h5>
        ...
        <form wire:submit.prevent="update" class="d-flex flex-column align-items-center">
          ...
          <button type="submit" wire:click="update()" class="btn btn-md text-white  text-center"
          style="background-color: #008080;">Update</button>
        </form>
        <div class="text-end">
          <button type="button" wire:click="toggleModal('edit')" class="btn btn-danger text-end">Cancel</button>
        </div>
  ...
  <div class="container mt-1 mb-4" style="overflow-y: auto;">
    <div class="row">
      ...
      <div class="mt-2 mb-2 p-1">
        <button class="btn btn-success float-end rounded-pill" wire:click="toggleModal('show')">+ Add New VC</button>
      </div>
      <div class="mt-2 mb-2">
        <div class="table-responsive">
          ...
          <td>
            <button class="btn btn-sm btn-primary rounded-pill" wire:click=edit('{{$data->id}}')>Edit</button>

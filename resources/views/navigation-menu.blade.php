<nav class="navbar navbar-expand-lg mb-3" style="background-color: #008080;">
  <div class="container-fluid">
    <a class="navbar-brand text-white" href="#">
      {{-- {{ Auth::user()->userrole == 0 ? 'State Admin - '.Auth::user()->name : (Auth::user()->userrole == 1 ? 'Office
      Admin - '. Auth::user()->name : (Auth::user()->userrole == 2 ? 'FMS User - '.)) }} --}}
    ...
    <li class="nav-item"><a class="nav-link text-white" href="#">Print Participants Data</a></li>
  @else
  <li class="nav-item"><a class="nav-link text-white" href="/addvc">Add VC</a></li>
  <li class="nav-item"><a class="nav-link text-white" href="/addparticipants">Add Participants</a></li>
  <li class="nav-item"><a class="nav-link text-white" href="#">View Participants Data</a></li>
  <li class="nav-item"><a class="nav-link text-white" href="#">Print Participants Data</a></li>
@endif
        <li class="nav-item">
